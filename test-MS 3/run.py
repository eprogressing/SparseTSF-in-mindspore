...
data_parser = {
    ...
    'weather':{'data':'weather.csv','T':'OT','M':[7,7,21],'S':[1,1,1],'MS':[7,7,1]},
    'traffic':{'data':'traffic.csv','T':'OT','M':[7,7,862],'S':[1,1,1],'MS':[7,7,1]},
    'electricity':{'data':'electricity.csv','T':'OT','M':[7,7,321],'S':[1,1,1],'MS':[7,7,1]}
}
