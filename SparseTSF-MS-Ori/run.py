...
from exp.exp_main import Exp_SparseTSF
...
with open(config.config_name, 'r') as f: #这个训练命令读入模块需要修改的
    tmp = yaml.YAML(typ='rt') ## 这里需要替换成 sh文件的输入格式，
    args = tmp.load(f) 
...
data_parser = {
    ...
    'weather':{'data':'weather.csv','T':'OT','M':[21,7,7],'S':[1,1,1],'MS':[7,7,1]},
    'traffic':{'data':'traffic.csv','T':'OT','M':[862,7,7],'S':[1,1,1],'MS':[7,7,1]},
    'electricity':{'data':'electricity.csv','T':'OT','M':[321,7,7],'S':[1,1,1],'MS':[7,7,1]}
}
...
for i in range(args.itr):
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(
                ...
                args.seq_len, args.label_len, args.pred_len,args.period_len,
