...
class Exp_SparseTSF(Exp_Basic):
    ...
    def train(self,model,setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            Allepoch_time.append(time.time() - epoch_time)
            
            aver_time = np.average(Allepoch_time)
        ...
        print('\n')
        print('Average Epoch Time:',aver_time)
        print('All Epoch Times:',Epoch_all_times)
        print('Cost:',aver_time*Epoch_all_times)
        print('\n')
